...
function Card(pokemon: Pokemon) {
  return (
    <Flex
      ...
      width={{ base: "90%", sm: "70%", md: "45%" , lg: "30%", xl: "20%", '2xl':"20%" }}
      borderRadius="5px"
      boxShadow="2xl"
    >
      ...
      >
        <GridItem>
          <Text fontSize="lg">Ataque</Text>
          <Flex flexDirection="row" justifyContent="center" gap="1" marginTop='10px'>
            <RiSwordFill size="1.5em"  color={theme.colors.gray[600]} />
            <Text textAlign="center">{pokemon.ataque}</Text>
          </Flex>
        </GridItem>
        <GridItem>
          <Text fontSize="lg">Salud</Text>
          <Flex flexDirection="row" justifyContent="center" gap="1" marginTop='10px'>
